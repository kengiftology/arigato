...
<li>呼び名をたずねた直後の十数秒に聞き取った言葉（文字にしたもの）</li></ul>
<h2>記録しないもの</h2>
<ul><li>氏名など個人を特定する情報（呼び名を教えてくれた方以外は、「1番の人」「2番の人」としか区別しません）</li>
<li>それ以外の会話（下の「呼び名をたずねるとき」の十数秒をのぞき、音は聞いていません）</li>
...
聞き取った言葉は<b>文字にして研究の記録として残します</b>（音は残しません）。
そのとき近くで話している方の言葉も、この十数秒のあいだは文字として残ることがあります。
何人かいるときもたずねることがあります（どなたに聞いているかを、服の色などで伝えるようにしていきます）。
同じ方に何度もたずねないようにしています。
