...
<li>人がいた時間帯</li>
<li>答えてくれた方の呼び名（本名でなくてかまいません。答えないこともできます）</li></ul>
<h2>記録しないもの</h2>
<ul><li>氏名など個人を特定する情報（呼び名を教えてくれた方以外は、「1番の人」「2番の人」としか区別しません）</li>
<li>会話の内容（下の「呼び名をたずねるとき」の数秒をのぞき、音は聞いていません）</li>
...
確かめ期間が終わったら消します。</p>
<h2>呼び名をたずねるとき</h2>
<p>キャラクターが「なんて よんだらいい？」とたずねた<b>直後の十数秒だけ</b>、マイクの音を聞き取ります。
聞き取った音は文字にしたうえで<b>その場で捨てます</b>。文字のうち残すのは<b>呼び名として取り出した言葉だけ</b>で、
ほかの言葉は残しません。答えなければ何も残りません。同じ方に何度もたずねないようにしています。
...
VOICE_GAIN = 1.125           # 音量。1.0＝作り置きのまま。本人「下げてよい」→ まず半分（2026-09-10）
