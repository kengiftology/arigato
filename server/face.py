...
_ENROLL_FACE_PX = 100        # 2026-09-10: 待つ向き(-0.50_0.30)で歩く人の正面は103〜118px。120では一度も卵ができなかった
...
_UP_MIN, _UP_MAX = 0.80, 1.30   # 2026-09-10: 天井のカメラは前を向いた顔でも上から見るので縮む。歩いた実測 0.81〜1.15（正面・鮮明）
